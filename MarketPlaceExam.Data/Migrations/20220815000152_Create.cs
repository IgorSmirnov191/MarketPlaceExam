        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipZipCode = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeGoods = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PayAddress = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PayCity = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockKeepUnitId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    QuantityPerUnit = table.Column<int>(type: "int", nullable: true),
                    UnitSize = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Specialised products used to provide a convenient source of nutrients when it is impractical to consume everyday foods", "Sports foods" },
                    { 2, "Supplements used to prevent or treat clinical issues including diagnosed nutrient deficiencies. Should be used within a larger plan under the expert guidance of a Medical Practitioner/Accredited Sports Dietitian.", "Medical supplements" },
                    { 3, "Supplements/ingredients that can support or enhance sports performance. Best used with an individualised and event-specific protocol, with the expert guidance of an Accredited Sports Dietitian.", "Performance supplements" },
                    { 4, "Food compounds which may have bioactivity including antioxidant and anti-inflammatory properties. May be consumed in food forms (whole or concentrate) or as isolated extracts.", "Food Polyphenols" },
                    { 5, "Compounds often found in foods which protect against oxidative damage from free-radical chemicals.", "Antioxidants" },
                    { 6, "Food derived compounds that interact with receptors in the mouth/ gut to activate the central nervous system.", "Tastants" },
                    { 7, "Compounds which attract interest for potential benefits to body function, integrity and/or metabolism.", "Other" }
                });

            migrationBuilder.InsertData(
                table: "Pictures",
                columns: new[] { "Id", "ProductId", "Uri" },
                values: new object[] { 1, null, "https:///aa-drink.com/uploads/drinks/2021-07-02-02-37-4024760210.png" });

            migrationBuilder.InsertData(
                table: "Suppliers",
                columns: new[] { "Id", "Address", "City", "Description", "Email", "Name", "Phone", "TypeGoods", "URL", "ZipCode" },
